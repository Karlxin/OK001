...
void Moto_Throttle(int16_t desthrottle)
{
    ...
    d2 = Constrain_up(desthrottle, 1780) + Constrain(cNd2_theta, 50, -50) + Constrain(cNd2_omega, 300, -300)  + Constrain((int16_t)Scd, 15, -15) + Constrain((int16_t)Ahd, 15, -15) ; //  planform        * *           / | \ X轴      	     Y轴
