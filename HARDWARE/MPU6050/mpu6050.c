...
/*******************************************************************************
	...
	* @Description		setting MPU6050 gyrometer sensor full scale range 
	* @Input    		fsr
	* @Use				None
	* @Output   		None
	* @Return   		0:success,else:error
...
/*******************************************************************************
	...
	* @Description		setting MPU6050 accelerometer sensor full scale range 
	* @Input    		fsr
	* @Use				None
	* @Output   		None
	* @Return   		0:success,else:error
...
/*******************************************************************************
	* @Name				MPU_Set_LPF
	* @Description		setting MPU6050 digital low pass filter
	* @Input    		lpf
	* @Use				None
	* @Output   		None
...
/*******************************************************************************
	* @Name				MPU_Set_Rate
	* @Description		setting MPU6050 sampling ratio(suppose Fs=1KHz)
	* @Input    		rate
	* @Use				None
	* @Output   		None
	* @Return   		0:success,else:error
